...
If you want a one click executable file, no need to worry about the source code or anything, download and run here (you may need to give it a minute after downloading while Windows File Deferender scans it): https://github.com/notatallshaw/fall_guys_ping_estimate/releases/download/v0.2.0/run_fgpe.exe
